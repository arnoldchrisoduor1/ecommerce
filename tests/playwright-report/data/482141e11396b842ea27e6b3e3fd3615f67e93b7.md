...
- Name: catalog-and-pdp.spec.ts >> Product detail page >> size chart modal opens
- Location: e2e\catalog-and-pdp.spec.ts:43:7
...
Locator: getByTestId('size-chart-modal')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('size-chart-modal')
