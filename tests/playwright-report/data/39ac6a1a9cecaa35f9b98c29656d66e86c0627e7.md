...
- Name: catalog-and-pdp.spec.ts >> Category / shop page >> live viewer badge renders on product cards
- Location: e2e\catalog-and-pdp.spec.ts:16:7
...
Locator: getByTestId('viewer-count-badge').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('viewer-count-badge').first()
