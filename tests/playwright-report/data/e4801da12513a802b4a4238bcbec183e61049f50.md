...
- Name: catalog-and-pdp.spec.ts >> Product detail page >> live viewer count and high-demand tag render on PDP
- Location: e2e\catalog-and-pdp.spec.ts:38:7
...
Locator: getByTestId('pdp-viewer-count')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('pdp-viewer-count')
...
- main:
  - img "Pocket Tee"
  - paragraph: Tees
  - heading "Pocket Tee" [level=1]
  - paragraph: KES 1,199 KES 1,399
  - text: Size
  - button "Size chart"
  - button "L"
  - button "M" [disabled]
  ...
  - button "Add to bag"
  - button "Save"
  - paragraph: Chest pocket detail.
  - list:
    - listitem: Secure checkout
    - listitem: 14-day returns
    - listitem: Delivery with named courier
    - listitem: M-Pesa · Card
  - region "Complete the look":
    - heading "Complete the look" [level=2]
    - article:
