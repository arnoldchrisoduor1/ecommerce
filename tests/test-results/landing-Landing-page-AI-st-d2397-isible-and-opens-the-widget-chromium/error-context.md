...
- Name: landing.spec.ts >> Landing page >> AI stylist chat launcher is visible and opens the widget
...
Locator: getByTestId('stylist-chat-panel')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('stylist-chat-panel')
